...
<div class="card">
    <div class="card-body">
        ...
        <div class="mb-3 d-flex justify-content-end">
            <button class="btn btn-primary btn-sm" title="Create new leave application" data-toggle="modal" data-target="#add-modal"><i class="fas fa-calendar-plus mr-2"></i>Apply</button>
        </div>
        @endif
                ...
                <table class="table table-striped table-bordered table-hover nowwrap data-table" width="100%" data-page-length="25">
                    ...
                    <thead>
                        <tr class="active">
                            ...
                            @endforeach
                            @if(Laratrust::can('update-leave|delete-leave'))
                    ...
                    <tbody>
                        ...
                        @foreach($users as $item)
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if(Laratrust::can('update-leave-type'))<a href="{{ route('leave.show', Crypt::encrypt($item->id)) }}" class="btn btn-primary btn-sm text-white" title="Edit {{ $item->title }}"><i class="fas fa-pencil-alt"></i></a>@endif
                                </td>
                                @endif
