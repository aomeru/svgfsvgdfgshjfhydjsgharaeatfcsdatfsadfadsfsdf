...
<div class="row">
    <div class="col-sm-3">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-3"><div class="col-5"><strong>Name</strong></div><div class="col-7">{{$manager->firstname.' '.$manager->lastname}}</div></div>
                <p class="mb-3">
                    <strong>Department</strong><br>
                    {{ $manager->unit == null ? '' : $manager->unit->title.', '.$manager->unit->department->title }}
                </p>
                <div class="row mb-3"><div class="col-5"><strong>Subordinates</strong></div><div class="col-7">{{$manager->users->count()}}</div></div>
            </div>
        </div>
    </div>
