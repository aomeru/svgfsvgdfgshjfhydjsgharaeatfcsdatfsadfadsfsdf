<div>
	...
	<div class="alert alert-danger bg-danger text-white text-center mb-5 alert-dismissible fade show" role="alert">
    ...
    <div class="alert alert-success bg-success text-white text-center mb-5 alert-dismissible fade show" role="alert">
